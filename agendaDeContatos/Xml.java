...
public class Xml implements Agenda {
    ...
    public String mostrarContato(Contato contato) {
        ...
        xmlData.append("    <telefone>").append(contato.getTelefone()).append("</telefone>\n");
        xmlData.append("    <email>").append(contato.getEmail()).append("</email>\n");
        xmlData.append("    <dataNascimento>").append(contato.getDataNascimento()).append("</dataNascimento>\n");
        xmlData.append("</contato>\n");

        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Dados => XML:\n");
        stringBuilder.append(xmlData.toString());
